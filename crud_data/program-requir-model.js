...
class Programs_req {
    ...
    async create(data) {
        let VALUES = [data.program_id,data.cpu,data.ram,data.display_resolution,data.storage_space,data.storage_type];
        let SQL = `INSERT INTO program_requirements (program_id,cpu,ram,display_resolution,storage_space,storage_type) VALUES($1,$2,$3,$4,$5,$6) RETURNING *`;
        try {
    ...
    async update(data) {
      let VALUES = [data.cpu,data.ram,data.display_resolution,data.storage_space,data.storage_type,data.program_id];
